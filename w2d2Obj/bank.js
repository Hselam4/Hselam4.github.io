...
const bank = {
   ...
   //IMPLEMENT THIS
   let sum=0;
   for (let cusomerBalance of bank.transactionsDB) {

    for(let allBalance of cusomerBalance.customerTransactions){
    sum +=allBalance;
   }
   }
   return sum;
   ...
   module.exports = {bank }; /*add all of your object names here that you need for the node mocha */ 